...
export function AuthBranding() {
  return (
    <div className="hidden md:flex w-1/2 bg-black p-8 flex-col justify-between relative overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-2 gap-4 mt-16">
        <div className="border border-white bg-black p-6 rounded flex flex-col transition-transform duration-200 hover:-translate-y-1">
        ...
        <div className="col-span-2 border border-white bg-black p-6 rounded transition-transform duration-200 hover:-translate-y-1">
